...
# COPY saves/monomono/monomono.zip /home/factorio/factorio/saves/save.zip
# COPY saves/server-settings.json /home/factorio/factorio/data/
...
# ENTRYPOINT /home/factorio/factorio/start_server.sh
# CMD /bin/bash
